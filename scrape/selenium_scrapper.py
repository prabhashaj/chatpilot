...
def selenium_scrape_and_save_to_csv(url):
    ...
    try:
        ...
        text_output_path = "./outputs/selenium_output.txt"
        routes_output_path = "./outputs/selenium_output[routes].csv"
        images_output_path = "./outputs/selenium_output[images].csv"
